...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-slate-900 relative overflow-hidden animated-bg">
      {/* Floating Elements */}
      <div className="bg-particles">
        <div className="floating-element floating-hexagon float-2 text-emerald-400" style={{top: '5%', left: '5%'}}></div>
        <div className="floating-element floating-circle float-4 text-blue-300" style={{top: '15%', right: '10%'}}></div>
        <div className="floating-element floating-square float-1 text-purple-300" style={{bottom: '20%', left: '15%'}}></div>
        <div className="floating-element floating-triangle float-5 text-emerald-300" style={{bottom: '10%', right: '5%'}}></div>
        <div className="floating-element floating-circle float-3 text-yellow-300" style={{top: '70%', left: '80%'}}></div>
      </div>
